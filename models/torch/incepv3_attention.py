...
if __name__ == "__main__"  or __name__ == "incepv3_attention":
...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14, hubpath = "/mnt/imagecaptioning/Image-Captioning-Attention-PyTorch/pretrained_model", pretrained = True):
        ...
        inception_v3 = torch.hub.load(hubpath, 'inception_v3', pretrained=pretrained, source = "local", aux_logits=False)
...
if __name__ == "__main__":
    input_t = torch.randn((1,3,256,256))
    inception = Encoder()
    out = inception(input_t)
