...
class Encoder(nn.Module):
    ...
    def __init__(self, encoded_image_size=14):
        ...
        vgg16 = torch.hub.load('../pretrained_model', 'vgg16', pretrained=True, source = "local")
        for c in vgg16.children():
            print(c)
        modules = list(vgg16.children())[:-2] # drop avgpool and linear layer
